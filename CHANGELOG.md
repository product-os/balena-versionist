...
* Switch from lodash to native methods [Pagan Gazzard]
* Switch from bluebird to native promises [Pagan Gazzard]
* Enable type checking for javascript files [Pagan Gazzard]
* Update dependencies [Pagan Gazzard]
* Move mochainon to dev dependencies [Pagan Gazzard]

# v0.15.2
## (2025-05-28)

* fix: Fix custom dependencies for config not being used [issenn]
